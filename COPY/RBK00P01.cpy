      ...
      * 
      *  
      * CONTAINER 'responseCode200-cont' contains 0 or 1 instances of
      *  structure 'RBK00P01-responseCode200', each of which
      *  represents an instance of JSON schema keyword
      *  'responseCode200'. The CONTAINER must be read from and
      ...
      *  
      *  
      * CONTAINER 'responseCode404-cont' contains 0 or 1 instances of
      *  structure 'RBK00P01-responseCode404', each of which
      *  represents an instance of JSON schema keyword
      *  'responseCode404'. The CONTAINER must be read from and
      *  written to in BIT mode.
      ...
      *  structure 'RBK00P01-responseCode500', each of which
      *  represents an instance of JSON schema keyword
      ...
      *  structure 'RBK00P01-authors', each of which represents an
      ...
      *  structure 'RBK00P01-authors2', each of which represents an
      *  instance of JSON schema keyword
      *  'responseCode404->authorsBooks->authors'. The CONTAINER must
